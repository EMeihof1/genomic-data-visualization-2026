...
In Figure 1, cells are visualized in physical tissue space and colored by cluster identity. There are three clusters of interest. Cluster 2 is labeled with a gold hue. Cluster 4 is labeled with a cyan hue. Cluster 6 is labeled with a magenta hue. In Figure 2, spatial expression patterns of two proteins (CD8 and CD20) are shown across the tissue. These proteins are differentially upregulated in the clusters of interest, showing increased expression in regions overlapping with Cluster 2. In the top right plot, the spatial expression of Aqp2 alone is shown with expression levels encoded by color saturation on a blue scale. Higher levels of expression localize to regions corresponding to the cluster of interest.
