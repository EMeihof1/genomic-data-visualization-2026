...
ggplot(df, aes(x= tSNE1, y=tSNE2)) + geom_point(size=2, alpha=0.2)
dim(embedding)
...
legend_plot <- ggplot(df, aes(x = tSNE1, y = tSNE2, col = clusters)) +
  geom_point(size = 3) +
...
# Row 1: tSNE and Spatial (2 plots spanning width)
row1 <- plot_grid(p1, p2, ncol = 2, rel_widths = c(1, 1))
